...
class DomainsApi
{
     ...
     * Check Domain
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getDomainName($domain_name)
    {
        list($response) = $this->getDomainNameWithHttpInfo($domain_name);
        return $response;
    }

    /**
     * Operation getDomainNameWithHttpInfo
     *
     * Check Domain
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     ...
     */
    public function getDomainNameWithHttpInfo($domain_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getDomainNameRequest($domain_name);
     ...
     */
    public function getDomainNameAsync($domain_name)
    {
        return $this->getDomainNameAsyncWithHttpInfo($domain_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDomainNameAsyncWithHttpInfo
     *
     * Check Domain
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainNameAsyncWithHttpInfo($domain_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getDomainNameRequest($domain_name);
    ...
    /**
     * Create request for operation 'getDomainName'
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function getDomainNameRequest($domain_name)
    {
        // verify the required parameter 'domain_name' is set
        if ($domain_name === null || (is_array($domain_name) && count($domain_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_name when calling getDomainName'
            );
        }

        $resourcePath = '/domains/check';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getDomainNamev2($domain_name)
    {
        list($response) = $this->getDomainNamev2WithHttpInfo($domain_name);
        return $response;
    }

    /**
     * Operation getDomainNamev2WithHttpInfo
     *
     * Check Domain for Client
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDomainNamev2WithHttpInfo($domain_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getDomainNamev2Request($domain_name);
    ...
    /**
     * Operation getDomainNamev2Async
     *
     * Check Domain for Client
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainNamev2Async($domain_name)
    {
        return $this->getDomainNamev2AsyncWithHttpInfo($domain_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDomainNamev2AsyncWithHttpInfo
     *
     * Check Domain for Client
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDomainNamev2AsyncWithHttpInfo($domain_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getDomainNamev2Request($domain_name);
    ...
    /**
     * Create request for operation 'getDomainNamev2'
     *
     * @param  string $domain_name Sorgulanacak alan adı. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDomainNamev2Request($domain_name)
    {
        // verify the required parameter 'domain_name' is set
        if ($domain_name === null || (is_array($domain_name) && count($domain_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_name when calling getDomainNamev2'
            );
        }

        $resourcePath = '/domains/check-for-client';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
