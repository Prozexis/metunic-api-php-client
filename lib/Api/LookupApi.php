...
class LookupApi
{
     ...
     *
     * @param  string $country_code Alfa-2 ülke kodu (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
    ...
    {
        list($response) = $this->getStatesWithHttpInfo($country_code);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatesWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getStatesRequest($country_code);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatesAsync($country_code)
    {
        return $this->getStatesAsyncWithHttpInfo($country_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatesAsyncWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getStatesRequest($country_code);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStatesRequest($country_code)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_code when calling getStates'
            );
        }

        $resourcePath = '/lookup/states/{countryCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getTldCountries()
    {
        list($response) = $this->getTldCountriesWithHttpInfo();
        return $response;
    }

    /**
     * Operation getTldCountriesWithHttpInfo
     *
     * (TLD) Ülke listesi getir
     *
     *
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTldCountriesWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTldCountriesRequest();
    ...
    /**
     * Operation getTldCountriesAsync
     *
     * (TLD) Ülke listesi getir
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTldCountriesAsync()
    {
        return $this->getTldCountriesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTldCountriesAsyncWithHttpInfo
     *
     * (TLD) Ülke listesi getir
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTldCountriesAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTldCountriesRequest();
    ...
    /**
     * Create request for operation 'getTldCountries'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTldCountriesRequest()
    {

        $resourcePath = '/lookup/tld/countries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getTldStates($country_code)
    {
        list($response) = $this->getTldStatesWithHttpInfo($country_code);
        return $response;
    }

    /**
     * Operation getTldStatesWithHttpInfo
     *
     * (TLD) İl/eyalet listesi getir
     *
     * @param  string $country_code Alfa-2 ülke kodu (required)
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTldStatesWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTldStatesRequest($country_code);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTldStatesAsync($country_code)
    {
        return $this->getTldStatesAsyncWithHttpInfo($country_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTldStatesAsyncWithHttpInfo
     *
     * (TLD) İl/eyalet listesi getir
     *
     * @param  string $country_code Alfa-2 ülke kodu (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTldStatesAsyncWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTldStatesRequest($country_code);
    ...
    /**
     * Create request for operation 'getTldStates'
     *
     * @param  string $country_code Alfa-2 ülke kodu (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTldStatesRequest($country_code)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_code when calling getTldStates'
            );
        }

        $resourcePath = '/lookup/tld/states/{countryCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getTrCountries()
    {
        list($response) = $this->getTrCountriesWithHttpInfo();
        return $response;
    }

    /**
     * Operation getTrCountriesWithHttpInfo
     *
     * (TR) Ülke listesi getir
     *
     *
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTrCountriesWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTrCountriesRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTrCountriesAsync()
    {
        return $this->getTrCountriesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTrCountriesAsyncWithHttpInfo
     *
     * (TR) Ülke listesi getir
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTrCountriesAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTrCountriesRequest();
    ...
    /**
     * Create request for operation 'getTrCountries'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTrCountriesRequest()
    {

        $resourcePath = '/lookup/tr/countries';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getTrStates
     *
     * (TR) İl/eyalet listesi getir
     *
     * @param  int $country_code country_code (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getTrStates($country_code)
    {
        list($response) = $this->getTrStatesWithHttpInfo($country_code);
        return $response;
    }

    /**
     * Operation getTrStatesWithHttpInfo
     *
     * (TR) İl/eyalet listesi getir
     *
     * @param  int $country_code (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTrStatesWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTrStatesRequest($country_code);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTrStatesAsync($country_code)
    {
        return $this->getTrStatesAsyncWithHttpInfo($country_code)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTrStatesAsyncWithHttpInfo
     *
     * (TR) İl/eyalet listesi getir
     *
     * @param  int $country_code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTrStatesAsyncWithHttpInfo($country_code)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getTrStatesRequest($country_code);
    ...
    /**
     * Create request for operation 'getTrStates'
     *
     * @param  int $country_code (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTrStatesRequest($country_code)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_code when calling getTrStates'
            );
        }

        $resourcePath = '/lookup/tr/states/{countryCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
