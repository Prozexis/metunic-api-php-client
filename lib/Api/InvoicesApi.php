...
class InvoicesApi
{
    ...
    /**
     * Operation getInvoicesByClient
     *
     * Makbuz Getir
     *
     * @param  string $status Makbuzun durumu. (optional, default to open)
     * @param  string $currency Makbuzun ödenmesi gereken para kuru. (optional, default to TRY)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function getInvoicesByClient($status = 'open', $currency = 'TRY')
    {
        list($response) = $this->getInvoicesByClientWithHttpInfo($status, $currency);
        return $response;
    }

    /**
     * Operation getInvoicesByClientWithHttpInfo
     *
     * Makbuz Getir
     *
     * @param  string $status Makbuzun durumu. (optional, default to open)
     ...
     */
    public function getInvoicesByClientWithHttpInfo($status = 'open', $currency = 'TRY')
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getInvoicesByClientRequest($status, $currency);
    ...
    /**
     * Operation getInvoicesByClientAsync
     *
     * Makbuz Getir
     *
     * @param  string $status Makbuzun durumu. (optional, default to open)
     ...
     */
    public function getInvoicesByClientAsync($status = 'open', $currency = 'TRY')
    {
        return $this->getInvoicesByClientAsyncWithHttpInfo($status, $currency)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInvoicesByClientAsyncWithHttpInfo
     *
     * Makbuz Getir
     *
     * @param  string $status Makbuzun durumu. (optional, default to open)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoicesByClientAsyncWithHttpInfo($status = 'open', $currency = 'TRY')
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->getInvoicesByClientRequest($status, $currency);
    ...
    /**
     * Create request for operation 'getInvoicesByClient'
     *
     * @param  string $status Makbuzun durumu. (optional, default to open)
     * @param  string $currency Makbuzun ödenmesi gereken para kuru. (optional, default to TRY)
     *
     ...
     */
    protected function getInvoicesByClientRequest($status = 'open', $currency = 'TRY')
    {
