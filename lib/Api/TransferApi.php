...
class TransferApi
{
     ...
     */
    public function transferAdd($auth, $domain)
    {
        list($response) = $this->transferAddWithHttpInfo($auth, $domain);
        return $response;
    }

    /**
     * Operation transferAddWithHttpInfo
     *
     * (TLD) Transfer İşlemi Başlat
     *
     ...
     */
    public function transferAddWithHttpInfo($auth, $domain)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->transferAddRequest($auth, $domain);
     ...
     */
    public function transferAddAsync($auth, $domain)
    {
        return $this->transferAddAsyncWithHttpInfo($auth, $domain)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transferAddAsyncWithHttpInfo
     *
     * (TLD) Transfer İşlemi Başlat
     *
     * @param  string $auth (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferAddAsyncWithHttpInfo($auth, $domain)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->transferAddRequest($auth, $domain);
    ...
    /**
     * Create request for operation 'transferAdd'
     *
     * @param  string $auth (required)
     * @param  string $domain (required)
     *
     ...
     */
    protected function transferAddRequest($auth, $domain)
    {
        // verify the required parameter 'auth' is set
        if ($auth === null || (is_array($auth) && count($auth) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $auth when calling transferAdd'
            );
        }
        // verify the required parameter 'domain' is set
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling transferAdd'
            );
        }

        $resourcePath = '/transfers/tld/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($auth !== null) {
            $queryParams['auth'] = ObjectSerializer::toQueryValue($auth, null);
        }
        // query params
        if ($domain !== null) {
    ...
    /**
     * Operation transferListTransferIn
     *
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function transferListTransferIn($service_id)
    {
        list($response) = $this->transferListTransferInWithHttpInfo($service_id);
        return $response;
    }

    /**
     * Operation transferListTransferInWithHttpInfo
     *
     * (TLD) Transfer İşlemi Durumu
     *
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transferListTransferInWithHttpInfo($service_id)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->transferListTransferInRequest($service_id);
    ...
    /**
     * Operation transferListTransferInAsync
     *
     * (TLD) Transfer İşlemi Durumu
     *
     * @param  int $service_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferListTransferInAsync($service_id)
    {
        return $this->transferListTransferInAsyncWithHttpInfo($service_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transferListTransferInAsyncWithHttpInfo
     *
     * (TLD) Transfer İşlemi Durumu
     *
     * @param  int $service_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferListTransferInAsyncWithHttpInfo($service_id)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->transferListTransferInRequest($service_id);
    ...
    /**
     * Create request for operation 'transferListTransferIn'
     *
     * @param  int $service_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function transferListTransferInRequest($service_id)
    {
        // verify the required parameter 'service_id' is set
        if ($service_id === null || (is_array($service_id) && count($service_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $service_id when calling transferListTransferIn'
            );
        }

        $resourcePath = '/transfers/tld/{serviceId}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
