...
class FileApi
{
     ...
     * Belge İndir
     *
     * @param  string $file_name Dosya Adı (required)
     *
    ...
    {
        list($response) = $this->downloadFileWithHttpInfo($file_name);
        return $response;
    }
     ...
     */
    public function downloadFileWithHttpInfo($file_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->downloadFileRequest($file_name);
     ...
     */
    public function downloadFileAsync($file_name)
    {
        return $this->downloadFileAsyncWithHttpInfo($file_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadFileAsyncWithHttpInfo($file_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->downloadFileRequest($file_name);
     ...
     */
    protected function downloadFileRequest($file_name)
    {
        // verify the required parameter 'file_name' is set
        if ($file_name === null || (is_array($file_name) && count($file_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file_name when calling downloadFile'
            );
        }

        $resourcePath = '/file/downloadFile/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Belge Ekle
     *
     * @param  string $domain_name_ Alan Adı (required)
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function uploadFile($domain_name_, $file = null)
    {
        list($response) = $this->uploadFileWithHttpInfo($domain_name_, $file);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadFileWithHttpInfo($domain_name_, $file = null)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->uploadFileRequest($domain_name_, $file);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsync($domain_name_, $file = null)
    {
        return $this->uploadFileAsyncWithHttpInfo($domain_name_, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadFileAsyncWithHttpInfo($domain_name_, $file = null)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->uploadFileRequest($domain_name_, $file);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadFileRequest($domain_name_, $file = null)
    {
        // verify the required parameter 'domain_name_' is set
        if ($domain_name_ === null || (is_array($domain_name_) && count($domain_name_) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_name_ when calling uploadFile'
            );
        }

        $resourcePath = '/file/uploadfile';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($domain_name_ !== null) {
            $queryParams['domainName '] = ObjectSerializer::toQueryValue($domain_name_, null);
        }
     ...
     * Çoklu Belge Ekle
     *
     * @param  string[] $files Yüklenecek dosyalar (required)
     ...
     * @return \Swagger\Client\Model\GeneralWebServiceResponse
     */
    public function uploadMultipleFiles($files, $domain_name)
    {
        list($response) = $this->uploadMultipleFilesWithHttpInfo($files, $domain_name);
        return $response;
    }

    /**
     * Operation uploadMultipleFilesWithHttpInfo
     *
     * Çoklu Belge Ekle
     *
     * @param  string[] $files Yüklenecek dosyalar (required)
     ...
     * @return array of \Swagger\Client\Model\GeneralWebServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadMultipleFilesWithHttpInfo($files, $domain_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->uploadMultipleFilesRequest($files, $domain_name);
    ...
    /**
     * Operation uploadMultipleFilesAsync
     *
     * Çoklu Belge Ekle
     *
     * @param  string[] $files Yüklenecek dosyalar (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipleFilesAsync($files, $domain_name)
    {
        return $this->uploadMultipleFilesAsyncWithHttpInfo($files, $domain_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation uploadMultipleFilesAsyncWithHttpInfo
     *
     * Çoklu Belge Ekle
     *
     * @param  string[] $files Yüklenecek dosyalar (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipleFilesAsyncWithHttpInfo($files, $domain_name)
    {
        $returnType = '\Swagger\Client\Model\GeneralWebServiceResponse';
        $request = $this->uploadMultipleFilesRequest($files, $domain_name);
    ...
    /**
     * Create request for operation 'uploadMultipleFiles'
     *
     * @param  string[] $files Yüklenecek dosyalar (required)
     * @param  string $domain_name Alan Adı (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadMultipleFilesRequest($files, $domain_name)
    {
        // verify the required parameter 'files' is set
        if ($files === null || (is_array($files) && count($files) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $files when calling uploadMultipleFiles'
            );
        }
        // verify the required parameter 'domain_name' is set
        if ($domain_name === null || (is_array($domain_name) && count($domain_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_name when calling uploadMultipleFiles'
            );
        }

        $resourcePath = '/file/uploadMultipleFiles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if (is_array($files)) {
            $files = ObjectSerializer::serializeCollection($files, 'multi', true);
        }
        if ($files !== null) {
            $queryParams['files'] = ObjectSerializer::toQueryValue($files, 'binary');
        }
        // query params
        if ($domain_name !== null) {
